...
const contactMethods = [
  {
    type: "email",
    label: "Email",
    value: "victor@example.com", // Placeholder - update with real email
  ...
  },
  {
    type: "github",
    label: "GitHub",
    value: "@victorouma", // Placeholder - update with real username
    href: "https://github.com/victorouma", // Placeholder - update with real URL
    icon: (
