  ...
  return (
    ...
    >
      <div className="container">
        ...
        {/* Copyright */}
        <div className="mt-6 pt-6 border-t border-[var(--color-border)] flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-[var(--color-text-muted)]">
            &copy; {currentYear} Victor Ouma. All rights reserved.
          </p>
          <p className="text-xs text-[var(--color-text-muted)]">
